...
<?php
    ...
    <td><?php
     if($status=="Ordered"){
         echo "<div style='color:black'>Ordered</div>";
    }
    if($status=="On Delivery"){
        echo "<div style='color:orange'>On Delivery</div>";
   }
   if($status=="Delivered"){
    echo "<div style='color:green'>Delivered</div>";
}
if($status=="Cancelled"){
...
<?php
        ...
        echo "<div style='color:red;'>No Orders Available</div>";
    }
    ?>
